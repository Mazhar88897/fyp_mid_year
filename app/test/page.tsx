...
//     // Call the API to save the entry to MongoDB
...
//     if (data.success) {
//       setEntries((prev) => [...prev, currentEntry as ContainerEntry]);
...
//   return (
//     <div className="p-6">
//         <h1 className="text-2xl font-bold">Search Box:</h1>
...
// // API Routes (handled inside the same file for simplicity)

// import { NextApiRequest, NextApiResponse } from 'next';
// import clientPromise from '../../lib/mongodb';

// export async function saveEntry(req: NextApiRequest, res: NextApiResponse) {
//   if (req.method === 'POST') {
//     const { containerNumber, formENumbers, company, submitted, date, image } = req.body;

//     try {
//       const client = await clientPromise;
//       const db = client.db();
//       const collection = db.collection('containerEntries');
...
// export async function deleteEntry(req: NextApiRequest, res: NextApiResponse) {
