      ...
      <header id="home" className="flex flex-col-reverse md:flex-row w-full h-screen max-w-7xl items-center justify-center p-8 relative overflow-x-hidden">
        <div className='w-full h-2/4 md:h-full md:w-2/5 flex flex-col justify-center items-center md:items-start gap-8'>
          <div className='flex flex-col gap-2'>
            <h1 className='text-4xl font-black md:text-8xl'>SmartDoc Assistant</h1>
            <h2 className='text-md md:text-2xl'>Start growing today!</h2>
          </div>
          <p className='max-w-md text-sm md:text-base text-zinc-500'>Empower Conversations with AI: Build Smarter Chatbots Effortlessly!</p>
          <div className='w-full flex items-center justify-center md:justify-start gap-4'>
          <a
  href="/llm"
  className="w-48 h-12 text-sm sm:text-base rounded bg-white text-black  transition-colors"
>
  Try 7 days free!
</a>
  ...
  return (
    <div className='w-full h-16 backdrop-filter backdrop-blur-xl bg-opacity-20 border-b flex items-center justify-center'>
      <div className='max-w-7xl w-full flex items-center justify-between p-4'>
        <h6 className='font-bold'>SmartDoc Assistant </h6>
